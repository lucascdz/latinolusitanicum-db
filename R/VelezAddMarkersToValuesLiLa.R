...
AddMarkersToValues <- function(SourceDFList){
   ...
   SourceDFList$EntriesDF$rdfs.seeAlso <- gsub("(.*)", "##\\1##", SourceDFList$EntriesDF$rdfs.seeAlso)
   ...
   SourceDFList$ComponentsDF$skos.note <- gsub("(.*)", "##\\1##", SourceDFList$ComponentsDF$skos.note)
   ...
   SourceDFList$LexicalEntriesDF$ontolex.canonicalForm <- gsub("(.*)", "<\\1>", SourceDFList$LexicalEntriesDF$ontolex.canonicalForm)
